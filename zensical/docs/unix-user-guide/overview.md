...
From Dyalog v14.1 onwards, [Ride](https://dyalog.github.io/ride) (Remote-IDE) can be used as the front end for Dyalog running on any platform; Ride itself is currently supported on Microsoft Windows, Linux, and macOS. For macOS, Ride is the default front-end for Dyalog, and is documented in [https://dyalog.github.io/ride](https://dyalog.github.io/ride). Ride can be downloaded from [https://my.dyalog.com](https://my.dyalog.com/). Be aware that Ride 2.0 works only with Dyalog v14 interpreters, and Ride 3 works only with Dyalog v15.0 interpreters onwards. Dyalog Ltd intends that this will be the last time that such an incompatibility will be introduced.
