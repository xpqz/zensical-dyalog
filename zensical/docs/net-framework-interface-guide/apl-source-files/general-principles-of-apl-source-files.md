...
Function bodies are defined between opening and closing _del_ (`∇`) characters. These are fixed by the Dyalog .NET Compiler using [`⎕FX`](../../language-reference-guide/system-functions/fx.md). Line numbers and white space formatting are ignored.
