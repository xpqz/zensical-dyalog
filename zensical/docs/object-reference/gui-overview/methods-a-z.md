...
|[ColSorted](../methodorevents/colsorted.md)|174|sets the sort image to be displayed in the column title of a [Grid](../objects/grid.md)|
...
|[DeleteTypeLib](../methodorevents/deletetypelib.md)|521|removes a loaded Type Library from the workspace|
...
|[GetFocusObj](../methodorevents/getfocusobj.md)|509|obtains a ref to the object that currently has the input focus|
...
|[GetZoomLevel](../methodorevents/getzoomlevel.md)|838|retrieves the current CEF ZoomLevel of the [HTMLRenderer](../objects/htmlrenderer.md)|
...
|[SetCellSet](../methodorevents/setcellset.md)|171|changes [CellSet](../properties/cellset.md) property for a cell in a [Grid](../objects/grid.md) .|
