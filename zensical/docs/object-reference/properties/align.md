...
This does not apply to a [TabControl](../objects/tabcontrol.md) for which the default value of Attach is `'None'  'None'  'None'  'None'`, regardless of the value of Align.
...
The value of the Align property can **only** be assigned by [`⎕WC`](../../language-reference-guide/system-functions/wc.md) and cannot be changed using [`⎕WS`](../../language-reference-guide/system-functions/ws.md).
