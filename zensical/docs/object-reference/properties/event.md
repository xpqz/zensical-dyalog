...
The function may be defined to return no result, a result, or a [shy](../../programming-reference-guide/introduction/results.md#shy-results) result. The result determines how the event is handled.
