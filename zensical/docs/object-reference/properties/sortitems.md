...
The value of the [Items](items.md) property reflects the order of the items displayed in the [List](../objects/list.md) object rather than the order in the array that was used to assign it.
