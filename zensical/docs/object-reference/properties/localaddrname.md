...
You can use either [LocalAddr](localaddr.md) or LocalAddrName to identify the local computer; if you specify both properties, the value of LocalAddrName will be ignored.
