...
The user can cause the column to disappear altogether by dragging it to a zero width. Once this has been done, this column can only be restored if the column to its left is itself not resizable.
