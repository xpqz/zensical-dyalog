...
The View property specifies how the items in a [ListView](../objects/listview.md) object are displayed. It is a character vector that can have one of the following values: `'Icon'` (the default), `'SmallIcon'`, `'List'`, or `'Report'`.
