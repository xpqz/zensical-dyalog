...
The [Grid](../objects/grid.md) object maintains a buffer of the most recent 8 changes made by the user since the [Values](../properties/values.md) property was last set by [`⎕WC`](../../language-reference-guide/system-functions/wc.md) or [`⎕WS`](../../language-reference-guide/system-functions/ws.md).
