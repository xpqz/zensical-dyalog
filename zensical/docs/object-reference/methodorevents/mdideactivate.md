...
The 3rd element of the event message contains the name of the [SubForm](../objects/subform.md) that has now been made the active one in the same [MDIClient](../objects/mdiclient.md).
