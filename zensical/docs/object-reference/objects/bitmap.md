...
Using a bitmap is always a 2-stage process. First you create a Bitmap object with [`⎕WC`](../../language-reference-guide/system-functions/wc.md). Then you use it by specifying its name as a property of another object.
