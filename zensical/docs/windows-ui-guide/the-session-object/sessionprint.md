...
!!! Info "Information"
    This event might be extended; in particular, the number of elements in the event message could be increased and the event might be generated by some system commands. You should, therefore, allow for such extensions in any code that refers to SessionPrint.
