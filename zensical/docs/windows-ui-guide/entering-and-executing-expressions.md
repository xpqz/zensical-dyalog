...
You don't have to change a line to mark it for re-execution; you can mark it by overtyping a character with the same character or by deleting a leading space for instance.
