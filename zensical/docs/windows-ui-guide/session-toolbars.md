...
| ![](img/print-object-icon.png) ![](img/nlf-disabled/print-object-icon.png) | Print Object | Executes the system operation `[ObjPrint]` . Prints the current object. If the object is being edited, the version of the object displayed in the edit window is printed. |
...
| ![](img/edit-array-icon.png)  | Edit using Array Notation | Edits the object using [array notation](../programming-reference-guide/introduction/arrays/array-notation.md). (With Native Look and Feel disabled the button is blank.)|
