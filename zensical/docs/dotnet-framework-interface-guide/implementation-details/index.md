...
For the names of these files corresponding to the version of Dyalog that you are using, see [Files](../../windows-installation-and-configuration-guide/files-and-directories/#files).
