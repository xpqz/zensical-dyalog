...
It is not currently possible to use Ride to debug APL shell scripts. However there is an _I-beam_ function, which can be used to provide some simple debugging/diagnostic information.
