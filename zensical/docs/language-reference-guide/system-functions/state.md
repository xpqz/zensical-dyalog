...
|-----|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
|`1⊃R`|Boolean vector, element set to 1 if and only if this level shadows `Y`. `(⍴1⊃R)=⍴⎕LC`                                                                 |
|`2⊃R`|Numeric vector giving the stack state of this name as it entered this level. `(⍴2⊃R)=⍴⎕LC` 0=not on stack 1=suspended 2=pendent (may also be suspended)|
|`3⊃R`|Numeric vector giving the name classification of `Y` as it entered this level. `(⍴3⊃R)=+/1⊃R`                                                          |
|`4⊃R`|Vector giving the contents of `Y` before it was shadowed at this level. `(⍴4⊃R)=+/0≠3⊃R`                                                               |
