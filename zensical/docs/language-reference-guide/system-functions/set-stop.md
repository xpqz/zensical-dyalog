...
`R` is a vector of the line numbers on which a stop control has been placed in ascending order.  The result is [shy](../../programming-reference-guide/introduction/results.md#shy-results).
