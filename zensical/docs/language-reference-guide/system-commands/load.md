...
`ws` specifies a file name. If no file extension is given, it is implied. See [WSEXT](../../windows-installation-and-configuration-guide/configuration-parameters/wsext.md).
