...
If a name includes the slash character  (`\` or `/`) it is taken to be the name of a file. See [Editing Scripts and Text Files](../../windows-ui-guide/editor.md#editing-scripts-and-text-files).
