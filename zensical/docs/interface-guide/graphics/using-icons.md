...
Setting `Dragable` to 2 specifies that an object is fully displayed while it is being dragged. Setting `Dragable` to 1 causes only the bounding rectangle around the object to be dragged.
