...
|-------------|----------------------|
|<code class="language-nonAPL">op_Equality</code>  |[`=`](../../language-reference-guide/primitive-functions/equal-to.md) and `≡`           |
|<code class="language-nonAPL">op_Inequality</code>|[`≠`](../../language-reference-guide/primitive-functions/not-equal-to.md) and `≢`           |
