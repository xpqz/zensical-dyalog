...
Calling the <code class="language-nonAPL">GetFiles</code> overload that does not take any arguments (from Dyalog by supplying an argument of [`⍬`](../../language-reference-guide/other-syntax/zilde.md)) returns a complete list of files:
```apl
      files←d.GetFiles ⍬
      files
