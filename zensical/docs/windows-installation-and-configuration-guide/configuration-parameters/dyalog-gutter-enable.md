...
- A left bracket `[` to identify groups of [implicit output](../../programming-reference-guide/introduction/output.md). Other forms of output are not identified in this way.
