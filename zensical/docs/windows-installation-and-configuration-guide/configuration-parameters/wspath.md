...
To load workspaces from the current directory, `.` must be included in the list defined by **WSPath**.
...
See also [Workspace search path](../configuring-the-ide/configuration-dialog.md#workspace-tab).
