...
This feature is provided to simplify the transition of older code to currently-supported versions of Dyalog. It does not prevent the generation and use of complex numbers using newer features (such as explicitly specifying a complex number literal), and the intention is that it will be removed in a future release of Dyalog.
