...
- There is a new _I-beam_ function to set the parameters for generating aplcore files dynamically. See [Set aplcore Parameters](https://help.dyalog.com/19.0/index.htm#Language/I%20Beam%20Functions/Set%20aplcore%20Parameters.htm#set_aplcore_parameters).
